...
import { dataURLtoFile } from "../../cropHelpers/dataURLtoFile";
...
export default function RenderCropper({ handleCropper,userId,proPic,renderProfile,}) {
	...
	return (
		<div className='container'>
			<IconButton className={classes.iconButton} onClick={handleCropper}>
				<CancelIcon style={{zIndex:1}} className={classes.cancelIcon} />
			</IconButton>
